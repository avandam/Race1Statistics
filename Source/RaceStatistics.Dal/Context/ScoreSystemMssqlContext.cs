    ...
    public class ScoreSystemMssqlContext : IScoreSystemContext
    {
            ...
            try
                {
                    ...
                    {
                        string query = "INSERT INTO RS_ScoreSystem (Name, FastestLapPoints) VALUES (@Name, @PointsForFastestLap)";
        ...
        internal bool ScoreSystemExists(string name)
        {
            try
            {
                using (SqlConnection connection = Database.Connection)
                {
                    string query = "SELECT COUNT(*) as nrOfRecordsFound FROM RS_ScoreSystem as scoreSystem WHERE scoreSystem.Name = @ScoreSystemName";
        ...
        public List<ScoreSystemInfo> GetScoreSystems()
        {
            ...
            try
            {
                using (SqlConnection connection = Database.Connection)
                {
                    string query = "SELECT scoreSystem.Name as name, scoreSystem.FastestLapPoints as points FROM RS_ScoreSystem as scoreSystem";
        ...
        public void RemoveScoreSystem(string name)
        {
            try
            {
                using (SqlConnection connection = Database.Connection)
                {
                    string query = "DELETE FROM RS_ScoreSystem WHERE name = @ScoreSystemName";
